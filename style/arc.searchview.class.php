...
class SearchView
{
    ...
    function GetPageListDM($list_len)
    {
        ...
        $infos = "<li>共找到<a>".$this->TotalResult."</a>条记录/最大显示<a>{$totalpage}</a>页 </li>";
        ...
        {
            $indexpage="<li class='cur'><a>首页</a></li>";
        }
        ...
        {
            $endpage="<li class='cur'><a>末页</a></li>";
        }
